...
vertex VertexOutLine lambertVertexLine(uint vid [[ vertex_id ]],
...
fragment half4 fragmentLightLine(VertexOutExplosion vert [[stage_in]], float2 uv[[point_coord]], texture2d<half>  diffuseTexture [[ texture(0) ]])
{
